...
- go to `view-source:https://10-10-39-96.p.thmlabs.com/`
- top comment shows another page being worked on
- open new tab to `view-source:https://10-10-39-96.p.thmlabs.com/new-home-beta`
- THM{HTML_COMMENTS_ARE_DANGEROUS}

![](./1_assets/2023-11-28-05-54-28.png)

What is the flag from the secret link?

- right click and open new tab
- `view-source:https://10-10-39-96.p.thmlabs.com/secret-page`
- THM{NOT_A_SECRET_ANYMORE}

![](./1_assets/2023-11-28-05-57-55.png)

What is the directory listing flag?

- open new tab to `view-source:https://10-10-39-96.p.thmlabs.com/assets/`
- open flag.txt
- THM{INVALID_DIRECTORY_PERMISSIONS}

What is the framework flag?

- find frame work at bottom of page
- open new tab to `https://static-labs.tryhackme.cloud/sites/thm-web-framework/`
- view change log `https://static-labs.tryhackme.cloud/sites/thm-web-framework/changelog.html`
- open new tab to `view-source:https://10-10-39-96.p.thmlabs.com/tmp.zip`
...
![](./1_assets/2023-11-28-06-25-35.png)
![](./1_assets/2023-11-28-06-26-32.png)
...
![](./1_assets/2023-11-28-06-38-05.png)
...
- found 2 flags on this item but one didn't work
- click on the POST line to see the first flag
- right click and open in new tab on the POST line to get the second flag
- `https://10-10-39-96.p.thmlabs.com/contact-msg`
- THM{GOT_AJAX_FLAG}

![](./1_assets/2023-11-28-06-45-20.png)

...
![](./Web_Requests/2023-11-06-08-00-13.png)
...
![](./Web_Requests/2023-11-06-08-01-14.png)
...
![](./Web_Requests/2023-11-06-08-02-11.png)
...
![](./Web_Requests/2023-11-06-08-04-14.png)

#### Questions

Answer the question(s) below to complete this Section and earn cubes!

Target: 94.237.62.49:34767  

What is the HTTP method used while intercepting the request? (case-sensitive)

- Look just before "HTTP/1.1"
...
- Use this command to get the answers

    - `curl <ip address>:<port> -v`
...
![](./Web_Requests/2023-11-06-11-29-05.png)
...
Target: 94.237.62.195:56266  

The server above loads the flag after the page is loaded. Use the Network tab in the browser devtools to see what requests are made by the page, and find the request to the flag.

![](./Web_Requests/2023-11-06-11-34-23.png)
...
![](./Web_Requests/2023-11-07-06-17-27.png)

Once we enter the credentials, we would get access to the page:

![](./Web_Requests/2023-11-07-06-18-03.png)
...
![](./Web_Requests/2023-11-07-06-18-59.png)
...
![](./Web_Requests/2023-11-07-06-19-47.png)
...
![](./Web_Requests/2023-11-07-06-20-28.png)
...
![](./Web_Requests/2023-11-07-06-21-08.png)
...
Target: 83.136.254.234:46360  

Authenticate to 83.136.254.234 with user "admin" and password "admin"

The exercise above seems to be broken, as it returns incorrect results. Use the browser devtools to see what is the request it is sending when we search, and use cURL to search for 'flag' and obtain the flag.

- `curl -u admin:admin http://83.136.254.234:46360/`
- `curl -u admin:admin -v http://83.136.254.234:46360/`
- `curl -H 'Authorization: Basic YWRtaW46YWRtaW4=' http://83.136.254.234:46360/`
- `curl -H 'Authorization: Basic YWRtaW46YWRtaW4=' http://83.136.254.234:46360/search.php?search=flag`

![](./Web_Requests/2023-11-07-06-34-02.png)

![](./Web_Requests/2023-11-07-06-35-00.png)

![](./Web_Requests/2023-11-07-06-36-15.png)
